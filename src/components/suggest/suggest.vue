<template>
  <div class="suggest">
    <div class="search-suggest"
      ...
      <p class="title"
         v-show="showSinger && showList">最佳匹配</p>
      <div @click="selectItem(suggest.artists[0])"
      ...
      <div @click="selectList(suggest.playlists[0])"
           class="search-suggest-item"
    ...
    <div v-show="!haveMore && !songs.length && query"
